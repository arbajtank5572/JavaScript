...
const NotesValues = document.querySelectorAll(".value-00");
...
numberInputs.forEach((input) => {
    input.addEventListener("input", (e) => {  
        ...
        const parentElement = target.closest(".ds-row");
        const nearestPerNoteValue = parentElement.querySelector(".value-00");
